...
public class RandomStringExample {
    ...
    public static void getAlphaNumericString(int n) {
        ...
        // Fix this shit over here bro I'm bout to kill my self
        ...
        if (r1 == JOptionPane.YES_OPTION) {
            ...
            if (r8 == JOptionPane.YES_OPTION) {
                ...
                if (fileExtension.equals("")) {
                    ...
                    JOptionPane.showMessageDialog(null, "Not generating file...", "Password Generator", JOptionPane.ERROR_MESSAGE);
                }
            } else {
